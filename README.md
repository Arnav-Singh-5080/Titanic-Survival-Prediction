...
This project demonstrates an end-to-end ML workflow, including preprocessing, analysis, feature engineering, scaling, regularization, and evaluation — all implemented in Python using Pandas, NumPy, Matplotlib, and Scikit-learn.
...
- Visualized survival trends using Matplotlib barplots and countplots.
...
- `Title` = extracted from “Name” column (Mr, Mrs, Miss, etc.)
...
- Ridge regularization balanced bias and variance effectively.  
